...
In this demonstration, I use the **Mutillidae II** training application, which contains a **Command Injection** vulnerability.

This vulnerability occurs when user input is passed to the operating system without adequate validation or sanitization, allowing an attacker to inject additional commands for execution.

**Command Injection** has several variants based on the technique and execution method, including:

1. **Basic Command Injection**
2. **Blind Command Injection**
3. **OS Command Injection**
4. **Argument Injection**
5. **Shell Metacharacter Injection**
6. **Newline Injection**
7. **Command Substitution Injection**
8. **Time-based Blind Command Injection**
9. **Out-of-Band (OOB) Command Injection**
10. **Filter Bypass Command Injection**
11. **Second-order Command Injection**

Some variants may overlap because they are categorized based on different characteristics, such as the injection technique, execution method, or application behavior.
