...
The documentation is organized into specific domains:
- **Architect/**: Infrastructure, systems engineering, and lab setups.
- **Teaming/**: Penetration testing (Red) and defensive strategies (Blue/Purple).
- **Malware/**: Exploit analysis and malware research.

## Connecting to the Frontend

To publish a new article to the website:
1. Write the markdown file and push it to the appropriate folder in this repository.
2. Open the file on GitHub and click the "Raw" button to get the raw URL (`https://raw.githubusercontent.com/...`).
3. Add this URL to the `data.js` file in the frontend repository.
...
3. Tambahkan URL tersebut ke dalam file `data.js` yang ada di repositori frontend.
